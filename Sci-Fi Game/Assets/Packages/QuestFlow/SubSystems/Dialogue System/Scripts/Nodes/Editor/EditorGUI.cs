...
namespace QuestFlow.DialogueEngine
{
    namespace DialogueSystem
    {
        public static class EditorGUI
        {
            ...
            public static void DrawDialogue (SerializedObject serializedObject)
            {
            ...
            public static void DrawConditions (SerializedObject serializedObject, DialogueEntry node)
            {
            ...
            public static void DrawActions (SerializedObject serializedObject, DialogueEntry node)
            {
            ...
            private static void AddCondition (Type type, DialogueEntry node)
            {
            ...
            private static void AddAction (Type type, DialogueEntry node)
            {
