...
public class LogitechSteeringWheel : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        float x = 256.0f;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Accelerator: " + InputWheel.Accelerator.ToString ( "0.00" ) );
        x += 16;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Brake: " + InputWheel.Brake.ToString ( "0.00" ) );
        x += 16;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Clutch: " + InputWheel.Clutch.ToString ( "0.00" ) );
        x += 16;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Steering: " + InputWheel.Steering.ToString ( "0.00" ) );

        x += 16;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Shift Down: " + InputWheel.ShiftDown );
        x += 16;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Shift Up: " + InputWheel.ShiftUp );
        x += 16;
        GUI.Label ( new Rect ( 64, x, 256, 256 ), "Gear: " + InputWheel.GearEnum );
    }
